    ...
    <div class="p-16">
      <div class="p-8 bg-white shadow mt-24">
        ...
        <div class="mt-20 text-center border-b pb-12">
          ...
          <p class="mt-8 text-gray-500">Students Branch Of IEEE</p>
        ...
        <div class="mt-12 flex flex-col justify-center">
          <p class="text-gray-600 text-center font-light lg:px-16">
            ...
            and educational activities. IEEE is the world's largest technical
            professional organization dedicated to advancing technology for the
            benefit of humanity. IEEE and its members inspire a global community
